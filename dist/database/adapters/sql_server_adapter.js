...
class SqlServerAdapter {
    ...
    async getTableRelationships(tableName, databaseName) {
        ...
        request.input('tableName', mssql_1.default.NVarChar, tableName);
    ...
    async queryPlan(sqlQuery, isAlreadyExplain) {
        if (isAlreadyExplain) {
    ...
    async executeRawQuery(sqlQuery, maxRows = constants_1.constants.MAX_ROWS) {
        ...
        return new Promise((resolve, reject) => {
            ...
            const timeoutTimer = setTimeout(() => {
                request.cancel();
            }, constants_1.constants.QUERY_TIMEOUT_MS);
